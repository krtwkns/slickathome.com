		...
		<div class="">
			...
			<div class="form-group">
					...
					<div class="input-group">
						...
						<input disabled type="text" class="form-control input-lg" id="nama_barang" value="<?php echo e(number_format($transaksi->total_harga, 0, ',', '.')); ?>" name="nama_barang"  >
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input disabled type="text" class="form-control input-lg" id="diskon" value="<?php echo e(number_format($transaksi->diskon, 0, ',', '.')); ?>" name="diskon" >
					</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input disabled type="text" class="form-control input-lg" id="laba" value="<?php echo e(number_format($transaksi->laba, 0, ',', '.')); ?>" name="laba"  >
					</div>
					</div>
				</div>				
				  ...
				  <thead>
				   ...
				   <?php $__empty_1 = true; $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?> 
				    <tr>
				    	...
				    	<td width="25%" style="text-align:center"><?php echo e($i->barang->nama_barang); ?></td>
